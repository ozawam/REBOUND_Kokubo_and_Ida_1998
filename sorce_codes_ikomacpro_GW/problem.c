...
//    r->usleep        = 10000;        // Slow down integration (for visualization only)
 ...
 //   reb_configure_box(r,boxsize,1,1,1);
   ...
   // Planetesimal disk parameters
    ...
    double total_disk_mass = 3000.0*pow(10.0,23.0)/M_sun;
...
//        double inc  = reb_random_rayleigh(0.00215);
        double e    = reb_random_rayleigh(0.0043/sqrt(2.0));
        double inc  = reb_random_rayleigh(0.00215/sqrt(2.0));
